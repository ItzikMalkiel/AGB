...
L1_lambda = 100.0
decayD = True
useAdaptiveLossBalancing = True
adaptiveGradBalancingRatio = 10
gan_weight = 100
RUN_NAME = "pix2pix-tensorflow/facades_agb_L1_100_GAN_100_epoch_200_ratio10"
...
parser.add_argument('--epoch', dest='epoch', type=int, default=num_epochs_to_train, help='# of epoch')
...
parser.add_argument('--sample_dir', dest='sample_dir', default= RUN_NAME + "/sample" , help='sample are saved here')
parser.add_argument('--test_dir', dest='test_dir', default= RUN_NAME + "/test", help='test sample are saved here')
